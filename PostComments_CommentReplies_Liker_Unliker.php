  ...
  try {
    ...
    if (isset($_SESSION['Username']) && preg_match('/'.$username.'/', $LikeConfirmer)) {
  	...
  	*/
      ...
      $activityLog_update = "$username liked your post ->   <a target='_blank' href='" .$link."' > View </a> ~ $timeComment_ReplyWasLiked ||";
    ...
    //  $dbh->bindParam(1, $activityLog_update, PDO::PARAM_STR);
  	...
  	*/
      ...
      $timeComment_ReplyWasLiked = time();
      $activityLog_update = "<b> $username </b> liked your post ->   <a target='_blank' href='" .$link."' > View </a> ~ $timeComment_ReplyWasLiked ||";
